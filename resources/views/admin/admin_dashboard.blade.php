                                    ...
                                    <div class="charts-main sherah-default-bg charts-home-two sherah-border mg-top-30">
                                        <div class="charts-main__heading  mg-btm-20 charts-main__heading--v2">
                                            ...
                                            <div class="sherah-charts-tabs">
                                                <!-- Tab List -->
                                                <div class="sherah-charts-tabs__list list-group " id="list-tab"
                                                    role="tablist">
                                                    <a class="list-group-item" data-bs-toggle="list" href="#sherah_tab1"
                                                        role="tab" href="profile.html">7 Days</a>
                                                    <a class="list-group-item active" data-bs-toggle="list"
                                                        href="#sherah_tab1" role="tab">Monthly</a>
                                                    <a class="list-group-item" data-bs-toggle="list" href="#sherah_tab1"
                                                        role="tab">Yearly</a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-12">
                                            ...
                                            <div
                                                ...
                                                <div class="sherah-order-card__first">
                                                    <p class="sherah-order-card__text mg-btm-10">Active Creator <span
                                                            class="sherah-bcolor">86,346</span></p>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            ...
                                            <div
                                                class="sherah-order-card sherah-default-bg sherah-border sherah-flex-between mg-top-30">
                                                <div class="sherah-order-card__first">
                                                    <p class="sherah-order-card__text mg-btm-10">Recent Order <span
                                                            class="sherah-bcolor">135,86,346</span></p>
                                                    <div class="sherah-chart__inside sherah-chart__inside--aorder">
                                ...
                                <div class="col-lg-6 col-12">
                                    ...
                                    <div class="charts-main sherah-default-bg charts-home-two sherah-border mg-top-30">
                                                    ...
                                                    <li class="nav-item dropdown">
                                                        ...
                                                        <ul class="dropdown-menu sherah-sidebar_dropdown">
                                                            <a class="list-group-item" data-bs-toggle="list"
                                                                data-bs-target="#sherah-chart__t1" role="tab">Last 15
                                                                Days</a>
                                                            <a class="list-group-item" data-bs-toggle="list"
                                                                data-bs-target="#sherah-chart__t1" role="tab">Last 7
                                                                Days</a>
                                                            <a class="list-group-item" data-bs-toggle="list"
                                        ...
                                        <div class="charts-main__one">
                                            <div class="tab-content" id="nav-tabContent">
                                                <div class="tab-pane fade show active" id="sherah-chart__t1"
                                                ...
                                                <div class="tab-pane fade" id="sherah-chart__t1" role="tabpanel"
                                            ...
                                            <tbody class="sherah-table__body">
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
                                                        <div class="sherah-table__product">
                                                            <div class="sherah-table__product-img">
                                                                <img src="{{ asset('backend/assets/customer-1.png') }}" alt="#">
                                                            </div>
                                                    ...
                                                    <td class="sherah-table__column-3 sherah-table__data-3">
                                                        <div class="sherah-table__product">
                                                            <div class="sherah-table__product-img">
                                                                <img src="{{ asset('backend/assets/img/product-1.png') }}" alt="#">
                                                            </div>
                                                            <div class="sherah-table__product-content">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
                                                        <div class="sherah-table__product">
                                                            <div class="sherah-table__product-img">
                                                                <img src="{{ asset('backend/assets/img/customer-2.png') }}" alt="#">
                                                            </div>
                                                            <div class="sherah-table__product-content">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
                                                        <div class="sherah-table__product">
                                                            <div class="sherah-table__product-img">
                                                                <img src="{{ asset('backend/assets/img/customer-3.png') }}" alt="#">
                                                            </div>
                                                            <div class="sherah-table__product-content">
                                                    ...
                                                    <td class="sherah-table__column-3 sherah-table__data-3">
                                                        <div class="sherah-table__product">
                                                            <div class="sherah-table__product-img">
                                                                <img src="{{ asset('backend/assets/img/product-3.png') }}" alt="#">
                                                            </div>
                                                            <div class="sherah-table__product-content">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
                                                        <div class="sherah-table__product">
                                                            <div class="sherah-table__product-img">
                                                                <img src="{{ asset('backend/assets/img/customer-4.png') }}" alt="#">
                                                            </div>
                                                            <div class="sherah-table__product-content">
                                                    ...
                                                    <td class="sherah-table__column-3 sherah-table__data-3">
                                                        <div class="sherah-table__product">
                                                            <div class="sherah-table__product-img">
                                                                <img src="{{ asset('backend/assets/img/product-4.png') }}" alt="#">
                                                            </div>
                                                            <div class="sherah-table__product-content">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
                                                        <div class="sherah-table__product">
                                                            <div class="sherah-table__product-img">
                                                                <img src="{{ asset('backend/assets/img/customer-5.png') }}" alt="#">
                                                            </div>
                                                            <div class="sherah-table__product-content">
                                                    ...
                                                    <td class="sherah-table__column-3 sherah-table__data-3">
                                                        <div class="sherah-table__product">
                                                            <div class="sherah-table__product-img">
                                                                <img src="{{ asset('backend/assets/img/product-5.png') }}" alt="#">
                                                            </div>
                                                            <div class="sherah-table__product-content">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
                                                        <div class="sherah-table__product">
                                                            <div class="sherah-table__product-img">
                                                                <img src="{{ asset('backend/assets/img/customer-1.png') }}" alt="#">
                                                            </div>
                                                            <div class="sherah-table__product-content">
                                                                <p class="sherah-table__product-desc">Alshan</p>
                                                            </div>
                                        ...
                                        <div class="sherah-product-slider">
                                            ...
                                            <div class="sherah-product-card sherah-default-bg sherah-border mg-top-30">
                                                ...
                                                <div class="sherah-product-card__img">
                                                    <img src="{{ asset('backend/assets/img/product-slider-1.png') }}">
                                                </div>
                                                <!-- Card Content -->
                                                <div
                                            ...
                                            <div class="sherah-product-card sherah-default-bg sherah-border mg-top-30">
                                                <!-- Card Image -->
                                                <div class="sherah-product-card__img">
                                                    <img src="{{ asset('backend/assets/img/product-slider-2.png') }}">
                                                </div>
                                                <!-- Card Content -->
                                                <div
                                                    class="sherah-product-card__content sherah-dflex-column sherah-flex-gap-5">
                                            ...
                                            <div class="sherah-product-card sherah-default-bg sherah-border mg-top-30">
                                                <!-- Card Image -->
                                                <div class="sherah-product-card__img">
                                                    <img src="{{ asset('backend/assets/img/product-slider-3.png') }}">
                                                </div>
                                                <!-- Card Content -->
                                                <div
                                                    class="sherah-product-card__content sherah-dflex-column sherah-flex-gap-5">
                                            ...
                                            <div class="sherah-product-card sherah-default-bg sherah-border mg-top-30">
                                                <!-- Card Image -->
                                                <div class="sherah-product-card__img">
                                                    <img src="{{ asset('backend/assets/img/product-slider-4.png') }}">
                                                </div>
                                                <!-- Card Content -->
                                                <div
                                                    class="sherah-product-card__content sherah-dflex-column sherah-flex-gap-5">
                                            ...
                                            <div class="sherah-product-card sherah-default-bg sherah-border mg-top-30">
                                                <!-- Card Image -->
                                                <div class="sherah-product-card__img">
                                                    <img src="{{ asset('backend/assets/img/product-slider-5.png') }}">
                                                </div>
                                                <!-- Card Content -->
                                                <div
                                                    class="sherah-product-card__content sherah-dflex-column sherah-flex-gap-5">
                                            ...
                                            <div class="sherah-product-card sherah-default-bg sherah-border mg-top-30">
                                                <!-- Card Image -->
                                                <div class="sherah-product-card__img">
                                                    <img src="{{ asset('backend/assets/img/product-slider-6.png') }}">
                                                </div>
                                                <!-- Card Content -->
                                                <div
                                                    class="sherah-product-card__content sherah-dflex-column sherah-flex-gap-5">
