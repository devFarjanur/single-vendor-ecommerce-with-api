                                ...
                                <div class="col-12 sherah-flex-between">
                                    ...
                                    <div class="sherah-breadcrumb">
                                        ...
                                        <ul class="sherah-breadcrumb__list">
                                            <li><a href="#">Home</a></li>
                                            <li class="active"><a href="{{ route('admin.order.list') }}">Order List</a></li>
                                        </ul>
                                    </div>
                                    <!-- End Sherah Breadcrumb -->
                                    <a href="" class="sherah-btn sherah-gbcolor">Add New Vendor</a>
                                </div>
                            </div>
                            <div class="sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                <div class="sherah-table__head sherah-table__main">
                                    ...
                                    <div class="sherah-order-right">
                                        <p class="sherah-order-text">October 7, 2020 at 9:08 pm / 3 items / Total $10254.00
                                        </p>
                                        <div class="sherah-table-status">
                                            <div class="sherah-table__status sherah-color2 sherah-color2__bg--opactity">Paid
                                            </div>
                                            <div class="sherah-table__status sherah-color3 sherah-color3__bg--opactity">
                                                Partially Fulfilled</div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <tbody class="sherah-table__body">
                                                    <tr>
                                                        <td class="sherah-table__column-1 sherah-table__data-1">
                                                            <div class="sherah-table__product--thumb">
                                                                <img
                                                                    src="{{ asset('backend/assets/img/product-img1.png') }}">
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td class="sherah-table__column-1 sherah-table__data-1">
                                                            <div class="sherah-table__product--thumb">
                                                                <img
                                                                    src="{{ asset('backend/assets/img/product-img2.png') }}">
                                                            </div>
                                                        </td>
                                                        <td class="sherah-table__column-2 sherah-table__data-2">
                                                            <div class="sherah-table__product-name">
                                                    ...
                                                    <tr>
                                                        <td class="sherah-table__column-1 sherah-table__data-1">
                                                            <div class="sherah-table__product--thumb">
                                                                <img
                                                                    src="{{ asset('backend/assets/img/product-img3.png') }}">
                                                            </div>
                                                        </td>
                                                        <td class="sherah-table__column-2 sherah-table__data-2">
                                                            <div class="sherah-table__product-name">
                                    ...
                                    <div class="sherah-contact-card sherah-default-bg sherah-border mg-top-30">
                                        ...
                                        <div class="sherah-vcard__body">
                                            <div class="sherah-vcard__img">
                                                <img src="{{ asset('backend/assets/img/vendor-4.png') }}" alt="#">
                                            </div>
                                                ...
                                                <ul class="sherah-vcard__contact">
                                                    <li><a href="tel:+91 564-258-4781">
                                                            <svg class="sherah-color1__fill"
                                                                xmlns="http://www.w3.org/2000/svg" width="13.983"
                                                                height="13.981" viewBox="0 0 13.983 13.981">
                                                                <path id="Path_468" data-name="Path 468"
                                                                    ...
                                                                    transform="translate(-229.038 -73.968)"></path>
                                                            </svg>+91 564-258-4781</a>
                                                    </li>
                                                    <li><a href="#">
                                                            <svg class="sherah-color1__fill"
                                                                xmlns="http://www.w3.org/2000/svg" width="12.331"
                                                                height="12.344" viewBox="0 0 12.331 12.344">
