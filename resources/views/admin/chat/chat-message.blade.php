                    ...
                    <div class="sherah-body">
                        ...
                        <div class="sherah-dsinner">
                            ...
                            <div class="sherah-chatbox__main">
                                ...
                                <div class="sherah-chatbox">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-3 col-12 sherah-chatbox__one mg-top-30">
                                            <div class="sherah-chatbox__sidebar sherah-default-bg sherah-border">

                                                <div class="sherah-chatbox__top">
                                                    <div
                                                        class="sherah-chatbox__inner sherah-border-btm pd-btm-20 mg-btm-10">
                                                        <div class="sherah-chatbox__author">
                                                            ...
                                                            <div class="sherah-chatbox__author-content">
                                                                ...
                                                                <p class="sherah-chatbox__author-desc">Available</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <form class="sherah-chatbox-form" action="#">
                                                        <input name="s" value="" type="text"
                                                            placeholder="Search">
                                                        <button class="search-btn" type="submit">
                                                            <svg class="sherah-color1__fill" width="16" height="16"
                                                    ...
                                                    <li>
                                                        <div class="sherah-chatbox__inner">
                                                            <div class="sherah-chatbox__author">
                                                                ...
                                                                <div class="sherah-chatbox__author-content">
                                                                    <h4 class="sherah-chatbox__author-title">Jamen Oliver
                                                                    </h4>
                                                                    <p class="sherah-chatbox__author-desc">Hey! You forgot
                                                                        your keys....</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="sherah-chatbox__inner">
                                                            <div class="sherah-chatbox__author">
                                                                ...
                                                                <div class="sherah-chatbox__author-content">
                                                                    <h4 class="sherah-chatbox__author-title">Brotherhood
                                                                    </h4>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="sherah-chatbox__inner">
                                                            <div class="sherah-chatbox__author">
                                                                ...
                                                                <div class="sherah-chatbox__author-content">
                                                                    <h4 class="sherah-chatbox__author-title">Rose Rovert
                                                                    </h4>
                                                                    <p class="sherah-chatbox__author-desc">Of course I work
                                                                        the finaly done ....</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="sherah-chatbox__inner">
                                                            <div class="sherah-chatbox__author">
                                                                ...
                                                                <div class="sherah-chatbox__author-content">
                                                                    <h4 class="sherah-chatbox__author-title">Thlatics Han
                                                                    </h4>
                                                                    <p class="sherah-chatbox__author-desc">Typing....</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <div class="sherah-chatbox__inner">
                                                            <div class="sherah-chatbox__author">
                                                                ...
                                                                <div class="sherah-chatbox__author-content">
                                                                    <h4 class="sherah-chatbox__author-title">Atlamtan Jhon
                                                                    </h4>
                                                                    <p class="sherah-chatbox__author-desc">Sent to your all
                                                                        files a ....</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="sherah-chatbox__inner">
                                                            <div class="sherah-chatbox__author">
                                                                ...
                                                                <div class="sherah-chatbox__author-content">
                                                                    <h4 class="sherah-chatbox__author-title">Nitanman</h4>
                                                                    <p class="sherah-chatbox__author-desc">Hi! How are you?
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="sherah-chatbox__inner">
                                                            <div class="sherah-chatbox__author">
                                                                ...
                                                                <div class="sherah-chatbox__author-content">
                                                                    <h4 class="sherah-chatbox__author-title">Hanmaram</h4>
                                                                    <p class="sherah-chatbox__author-desc">Let's go on the
                                                                        way.</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-lg-8 col-md-8 col-12  sherah-chatbox__two mg-top-30">
                                            <div class="sherah-chatbox__explore sherah-default-bg sherah-border">
                                                <div class="sherah-chatbox__explore-head sherah-border-btm">
                                                    <div class="sherah-chatbox__author">
                                                        <div
                                                            class="sherah-chatbox__author-img sherah-chatbox__author-img-sticky">
                                                        ...
                                                        <div class="sherah-chatbox__heading">
                                                            <h4 class="sherah-chatbox__heading--title">Hastamjaian</h4>
                                                            <p class="sherah-chatbox__heading--text sherah-pcolor">
                                                                Available</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="sherah-chatbox__explore-body">
                                                    <!-- Incomming List -->
                                                    <div class="sherah-chatbox__incoming">
                                                        <ul class="sherah-chatbox__incoming-list">
                                                            <!-- Single Incoming -->
                                                            <li>
                                                                <div class="sherah-chatbox__chat">
                                                                    ...
                                                                    <div class="sherah-chatbox__main-content">
                                                                        <div class="sherah-chatbox__incoming-chat">
                                                                            <p class="sherah-chatbox__incoming-text">Hey,
                                                                                Marshall! How are you? Can you please and
                                                                                change the color themei of the website to
                                                                                pink. I Can you as please change the color a
                                                                                theme of the website to pink and purple?</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                    ...
                                                    <!-- Outgoing List -->
                                                    <div class="sherah-chatbox__incoming sherah-chatbox__outgoing">
                                                        <ul class="sherah-chatbox__incoming-list">
                                                            <!-- Single Incoming -->
                                                            <li>
                                                                <div class="sherah-chatbox__chat">
                                                                    <div class="sherah-chatbox__main-content">
                                                                        <div class="sherah-chatbox__incoming-chat">
                                                                            <p class="sherah-chatbox__incoming-text">Send
                                                                                me the files please.</p>
                                                                        </div>
                                                                    </div>
                                                                    <div
                                                                        class="sherah-chatbox__author-img sherah-chatbox__author-img-sticky">
                                                            ...
                                                            <li>
                                                                <div class="sherah-chatbox__chat">
                                                                    <div class="sherah-chatbox__main-content">
                                                                        <div class="sherah-chatbox__incoming-chat">
                                                                            <p class="sherah-chatbox__incoming-text">Can
                                                                                you please change the color theme the
                                                                                website.</p>
                                                                        </div>
                                                                    </div>
                                                                    <div
                                                        ...
                                                        <ul class="sherah-chatbox__incoming-list">
                                                            ...
                                                            <li>
                                                                <div class="sherah-chatbox__chat">
                                                                    ...
                                                                    <div class="sherah-chatbox__main-content">
                                                                        <div class="sherah-chatbox__incoming-chat">
                                                                            <p class="sherah-chatbox__incoming-text">In
                                                                                computer programming, a comment is a
                                                                                progriammer as readable explanation or
                                                                                annotatons source code of a computer program
                                                                                They are added a our the purpose of making
                                                                                the source as code easier for humans to
                                                                                understand, and are generally ignored.There
                                                                                are many variations of passages of Lorem
                                                                                asIpsum available, but the majority have
                                                            ...
                                                            <li>
                                                                <div class="sherah-chatbox__chat">
                                                                    ...
                                                                    <div class="sherah-chatbox__main-content">
                                                                        <div class="sherah-chatbox__incoming-chat">
                                                                            <p class="sherah-chatbox__incoming-text">They
                                                                                are added with the purpose of making the
                                                                                source.</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <!-- Sherah Message Box  -->
                                                    <div class="sherah-chatbox__new-message">
                                                        <div class="sherah-chatbox__form">
                                                            <form class="sherah-chatbox__form-inner" action="#">
                                                                <div class="sherah-chatbox__button sherah-chatbox__v1">
                                                                    <a href="#">
                                                                        <svg class="sherah-offset__fill"
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            width="26.297" height="26.327"
                                                                ...
                                                                <div class="sherah-chatbox__button">
                                                                    <div class="sherah-chatbox__button-inline">
                                                                        <div
                                                                            class="sherah-chatbox__btn sherah-chatbox__record">
                                                                            <a href="#">
                                                                                <svg class="sherah-offset__fill"
                                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                                    width="14.586" height="24.076"
                                                                        ...
                                                                        <div
                                                                            class="sherah-chatbox__btn sherah-chatbox__imoji">
                                                                            <a href="#">
                                                                                <svg class="sherah-offset__fill"
                                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                                    width="25" height="25"
                                                                        ...
                                                                        <div
                                                                            class="sherah-chatbox__btn sherah-chatbox__image">
                                                                            <a href="#">
                                                                                <svg class="sherah-offset__fill"
                                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                                    width="26.725" height="24.498"
                                                                    ...
                                                                    <div class="sherah-chatbox__submit">
                                                                        <button class="sherah-chatbox__submit-btn"
                                                                            type="submit">
                                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                                width="18.695" height="16.249"
