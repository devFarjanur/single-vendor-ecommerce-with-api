                                                ...
                                                <ul class="nav-pills nav flex-nowrap product-thumbs" id="pills-tab"
                                                    ...
                                                    <li class="single-thumbs" role="presentation">
                                                        <a class="active" id="pills-home-tab" data-bs-toggle="pill"
                                                            ...
                                                            aria-selected="true">
                                                            <img src="{{ asset('backend/assets/img/product-detail.png') }}"
                                                                alt="thumbs">
                                                        </a>
                                                    </li>
                                                    <li class="single-thumbs" role="presentation">
                                                    ...
                                                    <div class="quantity">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="quant[1]" class="input-number"
                                                                data-min="1" data-max="10" value="0">
                                                    ...
                                                    <a href="#" class="sherah-btn default">
                                                        <svg class="sherah-default__fill sherah-default__heart"
                                                            ...
                                                            <path id="Path_533" data-name="Path 533"
                                                                ...
                                                                transform="translate(-90.794 -8.871)" stroke-width="1">
                                                            </path>
                                                        </svg>
                                                    </a>
                                                    <a href="#" class="sherah-btn default">
                                    ...
                                    <div class="col-12">
                                        <div class="tab-content" id="nav-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="p_tab_3" role="tabpanel"
                                                ...
                                                <div class="sherah-user-reviews">
                                                    ...
                                                    <div class="sherah-user-reviews__single">
                                                        <div class="shera-user-reviews_thumb">
                                                            <img src="{{ asset('backend/assets/img/review-1.png') }}">
                                                        </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="shera-user-reviews_thumb">
                                                            <img src="{{ asset('backend/assets/img/review-2.png') }}">
                                                        </div>
                                                        <div class="sherah-user-reviews__content">
                                                    ...
                                                    <div class="sherah-user-reviews__single">
                                                        <div class="shera-user-reviews_thumb">
                                                            <img src="{{ asset('backend/assets/img/review-3.png') }}">
                                                        </div>
                                                        <div class="sherah-user-reviews__content">
                                                            ...
                                                            <p class="sherah-user-reviews__text">Rreally liked it! What a
                                                                beautiful light it comes from! The radius of bright.</p>
                                                            <div class="sherah-user-reviews__buttons">
                                                                <a href="#"
                                                                    class="sherah-color3 sherah-color3__bg--opactity">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="17.136"
                                                    ...
                                                    <div class="sherah-user-reviews__single">
                                                        <div class="shera-user-reviews_thumb">
                                                            <img src="{{ asset('backend/assets/img/review-4.png') }}">
                                                        </div>
                                                        <div class="sherah-user-reviews__content">
                                                            <h4 class="sherah-user-reviews_title">Deniella Rhodes</h4>
                                                            <div
                                                ...
                                                <!-- Sherah Comment -->
                                                <div class="sherah-review-comment mg-top-30">
                                                    <h3 class="sherah-review-comment__title">Add Your Review</h3>
                                                    <form class="sherah-wc__form-main sherah-form-main--v2 p-0"
                                                        action="#" method="post">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">First Name
                                                                        *</label>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Email
                                                                        Address*</label>
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input"
                                                                            placeholder="Your email address here"
                                                                            type="text" name="e_address"
                                                                            required="required">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Review*</label>
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input sherah-wc__form-input--big" placeholder="Write your text" type="text"
                                                                            name="d_area" required="required"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group mg-top-30">
                                                            <button type="submit"
                                                                class="sherah-btn sherah-btn__primary">Submit Now</button>
                                                        </div>
                                                    </form>
                                                </div>
                                                <!-- End Sherah Comment -->
