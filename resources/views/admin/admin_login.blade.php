                ...
                <div class="col-lg-6 col-md-6 col-12 sherah-wc-col-two">
                    <div class="sherah-wc__form">
                        <div class="sherah-wc__form-inner">
                            ...
                            <!-- Sign in Form -->
                            <form class="sherah-wc__form-main p-0" method="post" action="{{ route('admin.login.store') }}">
                                @csrf
                                <div class="form-group">
                                    <label class="sherah-wc__form-label">Email Address</label>
                                    <div class="form-group__input">
                                        <input class="sherah-wc__form-input text-dark" type="email" name="email" placeholder="Email"
                                            required="required">
                                    </div>
                                </div>
                                <!-- Form Group -->
                                <div class="form-group">
                                    ...
                                    <div class="form-group__input">
                                        <input class="sherah-wc__form-input text-dark" id="password-field" type="password"
                                ...
                                <div class="form-group mg-top-20">
                                    <div class="sherah-wc__bottom">
                                        <p class="sherah-wc__text">Dont’t have an account ? <a
                                                href="{{ route('admin.register') }}">Sign up free</a></p>
                                    </div>
                                </div>
                            </form>
                            <!-- End Sign in Form -->
