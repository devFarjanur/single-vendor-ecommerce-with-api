                            ...
                            <div class="sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                ...
                                <div class="row">
                                            ...
                                            <table id="sherah-table__orderv1"
                                                ...
                                                <tbody class="sherah-table__body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="sherah-table__column-2 sherah-table__data-2">
                                                            <div class="sherah-table__product-name">
                                                                <h4 class="sherah-table__product-name--title">Sweater For
                                                                    Women</h4>
                                                                <p class="sherah-table__product-name--text">Color : Light
                                                                    White</p>
                                                            </div>
                                                        </td>
                                                        <td class="sherah-table__column-3 sherah-table__data-3">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="sherah-table__column-2 sherah-table__data-2">
                                                            <div class="sherah-table__product-name">
                                                                <h4 class="sherah-table__product-name--title">Convert for
                                                                    man shoe</h4>
                                                                <p class="sherah-table__product-name--text">Color : Black &
                                                                    Orange</p>
                                                            </div>
                                    ...
                                    <div class="col-12 mg-top-30">
                                        ...
                                        <p>All accounts are to be paid within 7 days from receipt of invoice. To be paid by
                                            cheque or credit card or direct payment online. If account is not paid within 7
                                            days</p>
                                        <p>the credits details supplied as confirmation of work undertaken will be charged
                                            the agreed quoted fee noted above.</p>
                                    </div>
                                    <div class="col-12">
                                        <div
