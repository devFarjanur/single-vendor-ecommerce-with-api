                                        ...
                                        <div class="sherah-psidebar sherah-default-bg">
                                            ...
                                            <div class="list-group sherah-psidebar__list" id="list-tab" role="tablist">
                                                <a class="list-group-item active" data-bs-toggle="list" href="#id1"
                                                    role="tab"><span class="sherah-psidebar__icon"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="15.137"
                                                            height="18.151" viewBox="0 0 15.137 18.151">
                                                ...
                                                <a class="list-group-item" data-bs-toggle="list" href="#id2"
                                                    role="tab"><span class="sherah-psidebar__icon"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="17.997"
                                                            height="18.151" viewBox="0 0 17.997 18.151">
                                                ...
                                                <a class="list-group-item" data-bs-toggle="list" href="#id3"
                                                    role="tab"><span class="sherah-psidebar__icon"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="14.234" height="18"
                                                    ...
                                                    </span><span class="sherah-psidebar__title">Notification
                                                        Setting</span></a>
                                                <a class="list-group-item" data-bs-toggle="list" href="#id4"
                                                    role="tab"><span class="sherah-psidebar__icon"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="18.329"
                                                            height="17.617" viewBox="0 0 18.329 17.617">
                                                ...
                                                <a class="list-group-item" data-bs-toggle="list" href="#id5"
                                                    role="tab"><span class="sherah-psidebar__icon"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="13.498"
                                                            height="17.259" viewBox="0 0 13.498 17.259">
                                                ...
                                                <a class="list-group-item" data-bs-toggle="list" href="#id6"
                                                    role="tab"><span class="sherah-psidebar__icon"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="14.217"
                                                            height="14.272" viewBox="0 0 14.217 14.272">
                                                    ...
                                                    </span><span class="sherah-psidebar__title">Connect With Social
                                                    </span></a>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="sherah-ptabs__inner">
                                                <div class="tab-content" id="nav-tabContent">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="sherah-ptabs__separate">
                                                                        <div class="sherah-ptabs__form-main">
                                                                            <div
                                                                                class="sherah__item-group sherah-default-bg sherah-border">
                                                                                <!--Profile Cover Info -->
                                                                                <div
                                                                                    class="sherah-profile-cover sherah-offset-bg sherah-dflex">
                                                                                    <div class="sherah-profile-cover__img">
                                                                                        <img src="{{ asset('backend/assets/img/profile-thumb.png') }}"
                                                                                            alt="#">
                                                                                    </div>
                                                                                    <div
                                                                                        class="sherah-profile-cover__content">
                                                                                        <h3
                                                                                            class="sherah-profile-cover__title">
                                                                                            Dolores Manlin</h3>
                                                                                        <span
                                                                                            class="sherah-profile-cover__text sherah-color1">I
                                                                                            am Professional Graphic
                                                                                            Designer</span>
                                                                                        <ul
                                                                                            class="sherah-social mg-top-30">
                                                                                            <li><a href="#"
                                                                                                    class="sherah-pcolor sherah-border sherah-default-bg"><i
                                                                                            ...
                                                                                            <li><a href="#"
                                                                                                    class="sherah-pcolor sherah-border sherah-default-bg"><svg
                                                                                ...
                                                                                <div
                                                                                    class="sherah-profile-info__v2 mg-top-30">
                                                                                    <h3
                                                                                        class="sherah-profile-info__heading mg-btm-30">
                                                                                        Personal Information</h3>
                                                                                    <ul
                                                                                        class="sherah-profile-info__list sherah-dflex-column">
                                                                                        <li class="sherah-dflex">
                                                                                            <h4
                                                                                                class="sherah-profile-info__title">
                                                                                                Full Name :</h4>
                                                                                            <p
                                                                                                class="sherah-profile-info__text">
                                                                                                Jangoch Ankon</p>
                                                                                        </li>
                                                                                        <li class="sherah-dflex">
                                                                                            <h4
                                                                                            ...
                                                                                            <p
                                                                                                ...
                                                                                                vitae Suspendisse velit mi,
                                                                                                pretium non euismod vitae
                                                                                            </p>
                                                                                        </li>
                                                                                        <li class="sherah-dflex">
                                                                                            <h4
                                                    ...
                                                    <div class="tab-pane fade" id="id2" role="tabpanel">
                                                        <form action="#">
                                                            <div
                                                                class="sherah-paymentm sherah__item-group sherah-default-bg sherah-border">
                                                                <!-- Payment Button -->
                                                                <div class="sherah__item-button--group mg-btm-20">
                                                                    <button class="sherah-btn">Add New Bank</button>
                                                                    <button class="sherah-btn sherah-btn__secondary">Add
                                                                        New Card</button>
                                                                </div>
                                                                <!-- End Payment Button -->
                                                                <h4 class="sherah-default-bg sherah-border__title">Add a
                                                                    payment method</h4>
                                                                <ul class="sherah-paymentm__list">
                                                                    <li class="sherah-paymentm__single">
                                                                        <div class="sherah-paymentm__name">
                                                                            <div class="sherah-paymentm__icon">
                                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                                    width="31.848" height="31.815"
                                                                            ...
                                                                            <div class="sherah-paymentm__content">
                                                                                <h4
                                                                                    class="sherah-paymentm__title sherah-pcolor">
                                                                                    Bank of America </h4>
                                                                                <p class="sherah-paymentm__text">
                                                                                    Bank<span>**************</span>5421</p>
                                                                                </p>
                                                                                <span
                                                                                    class="sherah-paymentm__badge sherah-color3">Verified</span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="sherah-paymentm__manage-btn">
                                                                            <button
                                                                                class="sherah-btn sherah-btn__fourth">Manage</button>
                                                                        </div>
                                                                    </li>
                                                                    <li class="sherah-paymentm__single">
                                                                        <div class="sherah-paymentm__name">
                                                                            ...
                                                                            <div class="sherah-paymentm__content">
                                                                                <h4
                                                                                    class="sherah-paymentm__title sherah-pcolor">
                                                                                    Master Card</h4>
                                                                                <p class="sherah-paymentm__text">Bank
                                                                                    **********5535</p>
                                                                                <span
                                                                                    class="sherah-paymentm__badge sherah-color3">Verified</span>
                                                                            </div>
                                                    ...
                                                    <div class="tab-pane fade" id="id3" role="tabpanel">
                                                        <form action="#">
                                                            <div
                                                                class="sherah-paymentm sherah__item-group sherah-default-bg sherah-border">
                                                                <ul
                                                                    class="sherah-paymentm__list sherah-paymentm__list--notify pt-0">

                                                                    <li
                                                                        class="sherah-paymentm__single sherah-paymentm__single--notify sherah-border">
                                                                        <div class="sherah-paymentm__name">
                                                                            <div
                                                                                class="sherah-paymentm__icon sherah-paymentm__icon--notify ntfmax__bgc--1">
                                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                                    width="20.004" height="17.387"
                                                                            ...
                                                                            <div class="sherah-paymentm__content">
                                                                                <h4
                                                                                    class="sherah-paymentm__title sherah-paymentm__title--notify">
                                                                                    Send Inactive for 7 days</h4>
                                                                                <p
                                                                                    class="sherah-paymentm__text sherah-paymentm__text--notify">
                                                                                    Unlockable content, only revealed by the
                                                                                    owner of the item.</p>
                                                                            </div>
                                                                        </div>
                                                                        <div
                                                                            class="sherah-ptabs__notify-switch  sherah-ptabs__notify-switch--two">
                                                                            <label class="sherah__item-switch">
                                                                                <input type="checkbox" checked="">
                                                                                <span
                                                                                    class="sherah__item-switch--slide sherah__item-switch--round"></span>
                                                                            </label>
                                                                        </div>
                                                                    </li>
                                                                    ...
                                                                    <li
                                                                        ...
                                                                        <div class="sherah-paymentm__name">
                                                                            ...
                                                                            <div class="sherah-paymentm__content">
                                                                                <h4
                                                                                    class="sherah-paymentm__title sherah-paymentm__title--notify">
                                                                                    New Contributions</h4>
                                                                                <p
                                                                                    class="sherah-paymentm__text sherah-paymentm__text--notify">
                                                                                    Evey new prodcuts upload seccessfullly
                                                                                    doen you can get notifcation</p>
                                                                            </div>
                                                                        </div>
                                                                        <div
                                                                            class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
                                                                    ...
                                                                    <li
                                                                        ...
                                                                        <div class="sherah-paymentm__name">
                                                                            ...
                                                                            <div class="sherah-paymentm__content">
                                                                                ...
                                                                                <p
                                                                                    class="sherah-paymentm__text sherah-paymentm__text--notify">
                                                                                    Every new products sell you can get
                                                                                    notification</p>
                                                                            </div>
                                                                        </div>
                                                                        <div
                                                                    ...
                                                                    <li
                                                                        ...
                                                                        <div class="sherah-paymentm__name">
                                                                            ...
                                                                            <div class="sherah-paymentm__content">
                                                                                <h4
                                                                                    class="sherah-paymentm__title sherah-paymentm__title--notify">
                                                                                    You swapped exactly</h4>
                                                                                <p
                                                                                    class="sherah-paymentm__text sherah-paymentm__text--notify">
                                                                                    Upload successfully done you can get
                                                                                    notification</p>
                                                                            </div>
                                                                        </div>
                                                                        <div
                                                                    ...
                                                                    <li
                                                                        ...
                                                                        <div class="sherah-paymentm__name">
                                                                            ...
                                                                            <div class="sherah-paymentm__content">
                                                                                <h4
                                                                                    class="sherah-paymentm__title sherah-paymentm__title--notify">
                                                                                    A new rating has been received</h4>
                                                                                <p
                                                                                    class="sherah-paymentm__text sherah-paymentm__text--notify">
                                                                                    Every new products sell you can get
                                                                                    notification</p>
                                                    ...
                                                    <div class="tab-pane fade" id="id4" role="tabpanel">
                                                        <form action="#">
                                                            <div
                                                                class="sherah-personals__history sherah-paymentm sherah__item-group sherah-default-bg sherah-border">
                                                                <table id="sherah-table__main"
                                                                    class="sherah-table__main sherah-table__main--activity">
                                                                    <thead class="sherah-table__head">
                                                                        <tr>
                                                                            <th
                                                                                class="sherah-table__column-1 sherah-table__h1">
                                                                                Name</th>
                                                                            <th
                                                                                class="sherah-table__column-2 sherah-table__h2">
                                                                                IP</th>
                                                                            <th
                                                                                class="sherah-table__column-3 sherah-table__h3">
                                                                                Time</th>
                                                                            <th
                                                                                class="sherah-table__column-4 sherah-table__h4">
                                                                                Action</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody class="sherah-table__body">
                                                                        <tr>
                                                                            <td
                                                                                class="sherah-table__column-1 sherah-table__data-1">
                                                                            ...
                                                                            <td
                                                                                class="sherah-table__column-2 sherah-table__data-2">
                                                                                <div class="sherah-table__product-content">
                                                                                    <p class="sherah-table__product-desc">
                                                                                        278.281.987.111</p>
                                                                                </div>
                                                                            ...
                                                                            <td
                                                                                class="sherah-table__column-3 sherah-table__data-3">
                                                                                <div class="sherah-table__product-content">
                                                                                    <p class="sherah-table__product-desc">
                                                                                        Mar 24, 2022 <span
                                                                                            class="sherah-table__time">04:26
                                                                                            PM</span></p>
                                                                                </div>
                                                                            </td>
                                                                            <td
                                                                                class="sherah-table__column-4 sherah-table__data-4">
                                                                                <div class="sherah-table__product-content">
                                                                                    <div
                                                                                        class="sherah-table__status__group">
                                                                                        <a href="#"
                                                    ...
                                                    <div class="tab-pane fade" id="id5" role="tabpanel">
                                                        <div
                                                            class="sherah-paymentm sherah__item-group sherah-default-bg sherah-border ">
                                                            <h4
                                                                class="sherah__item-group sherah-default-bg sherah-border__title">
                                                                Change Password</h4>
                                                            <div class="row">
                                                                <div class="col-xxl-8  col-lg-6 col-md-6 col-12">
                                                                    <!-- Sign in Form -->
                                                                    <form
                                                                        class="sherah-wc__form-main sherah-form-main--v2 p-0"
                                                                        action="#" method="post">
                                                                        <div class="form-group">
                                                                            <label class="sherah-wc__form-label">Old
                                                                                Password *</label>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label class="sherah-wc__form-label">New
                                                                                Password *</label>
                                                                            <div class="form-group__input">
                                                                                <input class="sherah-wc__form-input"
                                                                                    placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;"
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label class="sherah-wc__form-label">Re-enter
                                                                                Password *</label>
                                                                            <div class="form-group__input">
                                                                                <input class="sherah-wc__form-input"
                                                                                    placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;"
                                                                        ...
                                                                        <div class="form-group mg-top-30">
                                                                            <button type="submit"
                                                                                class="sherah-btn sherah-btn__primary">Changed
                                                                                Password</button>
                                                                        </div>
                                                                    </form>
                                                                    <!-- End Sign in Form -->
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6 col-md-6 col-12">
                                                                    <div class="sherah-password__img">
                                                                        <img src="{{ asset('backend/assets/img/p-update-img.png') }}"
                                                                            alt="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="tab-pane fade" id="id6" role="tabpanel">
                                                        <div class="sherah-accordion accordion accordion-flush sherah__item-group sherah-default-bg sherah-border"
                                                            id="sherah-accordion">
                                                            <div
                                                                class="sherah__item-group sherah-default-bg sherah-border mg-top-30">
                                                                <h4 class="sherah-default-bg sherah-border__title">Social
                                                                    Account</h4>
                                                                    ...
                                                                    <form class="sherah-wc__form-main p-0">
                                                                        <div class="row">
                                                                            <div class="col-lg-6 col-12">
                                                                                <div
                                                                                    class="sherah__item-form--group mg-top-form-20">
                                                                                    <label
                                                                                        class="sherah-wc__form-label">Facebook
                                                                                        *</label>
                                                                                    <div class="sherah-input-icon">
                                                                                        ...
                                                                                        <div
                                                                                            class="sherah-form-icon sherah-color1">
                                                                                            <i
                                                                            ...
                                                                            <div class="col-lg-6 col-12">
                                                                                <div
                                                                                    class="sherah__item-form--group mg-top-form-20">
                                                                                    <label
                                                                                        class="sherah-wc__form-label">Instagram
                                                                                        *</label>
                                                                                    <div class="sherah-input-icon">
                                                                                        <input
                                                                                            class="sherah-wc__form-input"
                                                                            ...
                                                                            <div class="col-lg-6 col-12">
                                                                                <div
                                                                                    class="sherah__item-form--group mg-top-form-20">
                                                                                    <label
                                                                                        class="sherah-wc__form-label">Twitter
                                                                                        *</label>
                                                                                    <div class="sherah-input-icon">
                                                                                        <input
                                                                                            class="sherah-wc__form-input"
                                                                            ...
                                                                            <div class="col-lg-6 col-12">
                                                                                <div
                                                                                    class="sherah__item-form--group  mg-top-form-20">
                                                                                    <label
                                                                                        class="sherah-wc__form-label">Google
                                                                                        Plus*</label>
                                                                                    <div class="sherah-input-icon">
                                                                                        <input
                                                                                            class="sherah-wc__form-input"
                                                                                        ...
                                                                                        <div
                                                                                            class="sherah-form-icon sherah-color1">
                                                                                            <i
                                                                                                class="fa-brands fa-google-plus"></i>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6 col-12">
                                                                                <div
                                                                                    class="sherah__item-form--group  mg-top-form-20">
                                                                                    <label
                                                                                        class="sherah-wc__form-label">Pinterest*
                                                                                    </label>
                                                                                    <div class="sherah-input-icon">
                                                                                        <input
                                                                                            class="sherah-wc__form-input"
                                                                            ...
                                                                            <div class="col-lg-6 col-12">
                                                                                <div
                                                                                    class="sherah__item-form--group  mg-top-form-20">
                                                                                    <label
                                                                                        class="sherah-wc__form-label">Dribbble
                                                                                        *</label>
                                                                                    <div class="sherah-input-icon">
                                                                                        <input
                                                                                            class="sherah-wc__form-input"
                                                                            ...
                                                                            <div class="col-lg-6 col-12">
                                                                                <div
                                                                                    class="sherah__item-form--group  mg-top-form-20">
                                                                                    <label
                                                                                        class="sherah-wc__form-label">Linkedin
                                                                                        *</label>
                                                                                    <div class="sherah-input-icon">
                                                                                        <input
                                                                                            class="sherah-wc__form-input"
                                                                            ...
                                                                            <div class="col-lg-6 col-12">
                                                                                <div
                                                                                    class="sherah__item-form--group  mg-top-form-20">
                                                                                    <label
                                                                                        class="sherah-wc__form-label">Behance
                                                                                        *</label>
                                                                                    <div class="sherah-input-icon">
                                                                                        <input
                                                                                            class="sherah-wc__form-input"
                                                                        ...
                                                                        <div class="row mg-top-30">
                                                                            <div class="sherah__item-form--group">
                                                                                <button type="submit"
                                                                                    class="sherah-btn sherah-btn__primary">Save
                                                                                    Now</button>
                                                                            </div>
                                                                        </div>
                                                                    </form>
                                                    ...
                                                    <div class="tab-pane fade" id="id7" role="tabpanel">
                                                        <div
                                                            class="sherah-ptabs__page sherah__item-group sherah-default-bg sherah-border">
                                                            <h4
                                                                class="sherah__item-group sherah-default-bg sherah-border__title">
                                                                Terms and Conditions</h4>
                                                            <h3 class="sherah-ptabs__page-title">1. Definitions</h3>
                                                            <p>What you do own when you buy an NFT are the keys to a
                                                                non-fungible – perhaps unique – token. That token is yours
                                                                to trade or hold or display in Decentraland. But the digital
                                                                file associated with an NFT is just as easy to copy and
                                                                paste and download as any other – the Finally, players lose
                                                                their NFTs sometimes according to the rules and regulations
                                                                of the NFT game.</p>
                                                            ...
                                                            <p>Amet minim mollit non deserunt ullamco est sit aliqua dolor
                                                                ...
                                                                amet.Capacity. You confirm that you have the legal capacity
                                                                to receive and hold and make use of the NFT under French
                                                                jurisdiction and any other relevant jurisdiction.Acceptance.
                                                                By participating in the Sale, You accept and agree to these
                                                                Terms and Conditions without any condition or restriction.If
                                                                You do not agree to this Contract, You shall not participate
                                                                in the Sale made by the Company Exercitation veniam
                                                                consequat sunt nostrud amet.Capacity. You confirm that you
                                                                have the legal capacity to receive and hold find to
                                                                end.Contract, You shall not participate in the Sale made by
                                                                the Company Exercitation venia</p>

                                                            <blockquote>In reality, the most important aspect of a great
                                                                dashboard is the part that gets the least amount of
                                                                attention: The underlying data. More than any other aspect,
                                                                the data will make or break a dashboard.Within this
                                                                definition, successful administration appears to rest on
                                                                three basic skills, which we will call technical, and
                                                                conceptual.
                                                            </blockquote>

                                                            <h3 class="sherah-ptabs__page-title">3. The Sale</h3>
                                                            <p>The Company offers NFTs featuring the Betonyou universe. The
                                                                holders of one or more NFTs will be able to win cryptos
                                                                while playing video games. In the future, the Company plans
                                                                to develop its own games and Metaverse around the Betonyou
                                                                universe (“Project”).</p>
                                                            <p>To release the NFTs and fund the project, the Company offers
                                                                NFTs from a dedicated website("Sale"). The web address of
                                                                this website will be given at the time of the mint. The NFT
                                                                acquisition does not confer any rights on the Company or in
                                                                the future development.</p>

                                                            <h3 class="sherah-ptabs__page-title">4. Purchaser’s obligations
                                                            </h3>
                                                            <p>To the fullest extent permitted by applicable law, You
                                                                undertake to indemnify, defend and hold harmless the Company
                                                                from and against all claims, demands, actions, damages,
                                                                losses, costs and expenses (including attorneys’ fees) that
                                                                arise from or relate to (i) your Subscription or use of the
                                                                NFTs; (ii) your responsibilities or obligations under this
                                                                Contract; and (iii) your breach of this Contract.</p>

                                                            <p>Company undertakes to act with the care normally expected
                                                                from a professional in his field and to comply with the best
                                                                practice in force. The best endeavor obligation only binds
                                                                the Company.</p>
